...
{   
	...
	public static void Dropdown1(WebElement cat, String visible)
	{
		// WebElement myEleDp = wd.findElement(By.id(cat));
	...
	public void login(WebDriver wd, String url, String User, String Pass)
	{
		...
		// if(url=="https://fusionpro.verixo.net/Login.aspx")
	...
	/*public void config() 
	{
		...
		String path= System.getProperty("D:\\LTM\\LTM")+"\\reports\\index_Teradici.html";
		ExtentSparkReporter reporter= new ExtentSparkReporter(path);
		reporter.config().setReportName("Teradici Test Cases");
   ...
   { 
    ...
    public static void TakeScreenshot(String FileName, WebDriver wd)
	{
		try {
			...
			Files.copy(srcFile, new File("D:\\Insert\\Custom_Report_Screenshot\\ " + FileName + "" + timestamp + ".png"));
